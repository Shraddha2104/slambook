"""
Django settings for slambook project.
...
SECRET_KEY = 'nnz&w^m9z7kg##+e4af*j$@l7(zuf!_y3e%qe03ul3^dzpj#nb'
...
WSGI_APPLICATION = 'slambook.wsgi.application'
